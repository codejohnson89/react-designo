...
const Footer = () => {
    ...
    return (
        ...
        <footer className="container">
                ...
                <div className="d-block d-sm-none customBorder"></div>
                <Row className="bottomSectionFooter">
                <Col lg={6} sm={8} className="row">
                    <Col sm={6} className="companyLocation">
                        <p>Designo Central Office<br></br>
                        3886 Wellington Street<br></br>
                        Toronto, Ontario M9C 3J5</p>
                    </Col>
                    <Col sm={6} className="companyContact">
                        <p>Contact Us (Central Office)<br></br>
                        P : +1 253-863-8967<br></br>
                        M : contact@designo.co</p>
                    </Col>
                </Col>
                    <Col lg={3} sm={4} className="offset-lg-3 social-media">
